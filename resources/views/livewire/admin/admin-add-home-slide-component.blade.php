                                ...
                                <div class="card-body">
                                    ...
                                    <form wire:submit.prevent="storeCategory">
                                        ...
                                        <div class="md-3 mt-3">
                                            ...
                                            <input type="text"  class="form-control" placeholder="Enter slide subtitle title" wire:model="sub_title" />
                                            @error('sub_title')
                                                <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="md-3 mt-3">
                                            ...
                                            <input type="text"  class="form-control" placeholder="Enter slide links" wire:model="link" />
                                            @error('link')
                                                <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary float-end">Submit</submit>
                                    </form>
                                </div>
                        </div>
                    </div>
