        ...
        <div class="container pt-25">
            <div class="row mb-50">
                <div class="col-lg-12 col-md-12 text-center">
                    ...
                    <h2 class="mb-15 text-grey-1 wow fadeIn animated">Take a look what<br> our team consists of</h2>
                    ...
                    <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                        ...
                        <div class="pl-30">
                            <h5 class="mb-5 fw-500">
                                Graciously Joachim Dkhar
                            </h5>
                            <p class="font-sm text-grey-5">ICFAI BCA VI</p>
