                        ...
                        <div class="shop-product-fillter">
                            ...
                            <div class="sort-by-product-area">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            <li><a class="{{$orderBy=='Default Sorting' ? 'active' : ''}}" href="#" wire:click.prevent="changePageSize(12)" href="#" wire:click.prevent="changeOrderBy('Default Sorting')">Default Sorting</a></li>
